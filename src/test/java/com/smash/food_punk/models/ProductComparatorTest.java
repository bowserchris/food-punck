...
public class ProductComparatorTest {
	...
	static Stream<Arguments> testNonMatchingProducts() {
		...
		Product sweetApple1 = new Product("Granny Smith Apple", 1.5);
		Product sweetApple2 = new Product("Sour Apple", 1.55);
		Product iPhone1 = new Product("iPhone 15", 1200.00);
	...
	public void compare2SameProductsEqualSuccessTest(Product p1, Product p2) {
	...
	public void compare2DifferentProductsNotEqualSuccessTest(Product p1, Product p2) {
		ProductComparator pc = new ProductComparator();
		assertNotEquals(0, pc.compare(p1, p2));
	}
